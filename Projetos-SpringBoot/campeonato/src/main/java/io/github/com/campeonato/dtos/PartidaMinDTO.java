...
public record PartidaMinDTO(
        ...
        CampeonatoMinDTO campeonato

) {
    public PartidaMinDTO(Partida entity) {
        this(
                entity.getId(),
                entity.getData(),
                entity.getMandante(),
                ...
                entity.getCampeonato() != null ? new CampeonatoMinDTO(entity.getCampeonato()) : null
        );
    }
}
